...
# subset_samples <- c('RP_S42', 'RP_S41')
# 
...
MTandem_obj$apply_alignment(method = 'ow',
                            bin_size = 1,
...
xcms::plotAdjustedRtime(MTandem_obj$data, col = col_vector, lwd = 3, cex = .7)
...
nrow(xcms::featureDefinitions(MTandem_obj$data))
